...
signed main(){
    ...
    while(q--){
        int a, b, c; cin>>a>>b>>c;
        update(a, b, 1, -c);
        cout<<max(0ll, query(a, b, 1))<<" "<<max(0ll, seg[1].sum)<<endl;
    }
}